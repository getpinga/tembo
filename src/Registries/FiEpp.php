...
class FiEpp implements EppRegistryInterface
{
    private $resource;
    private $isLoggedIn;
    private $prefix;
    ...
    public function __construct()
    {
        ...
        $responseHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/response-fi.log', 0, Logger::DEBUG);
        $requestHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/request-fi.log', 0, Logger::DEBUG);
        $commonHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/common-fi.log', 0, Logger::DEBUG);
