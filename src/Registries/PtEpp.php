...
class PtEpp implements EppRegistryInterface
{
    private $resource;
    private $isLoggedIn;
    private $prefix;
    ...
    public function __construct()
    {
        ...
        $responseHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/response-pt.log', 0, Logger::DEBUG);
        $requestHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/request-pt.log', 0, Logger::DEBUG);
        $commonHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/common-pt.log', 0, Logger::DEBUG);
