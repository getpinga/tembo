...
class HrEpp implements EppRegistryInterface
{
    private $resource;
    private $isLoggedIn;
    private $prefix;
    ...
    public function __construct()
    {
        ...
        $responseHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/response-hr.log', 0, Logger::DEBUG);
        $requestHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/request-hr.log', 0, Logger::DEBUG);
        $commonHandler = new RotatingFileHandler(dirname(__FILE__) . '/../../log/common-hr.log', 0, Logger::DEBUG);
